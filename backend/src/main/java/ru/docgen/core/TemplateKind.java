...
public enum TemplateKind {
    ...
    CUSTOM(
            "custom",
            "Свой шаблон",
            "Настраиваемое оформление: шрифт, размер, межстрочный интервал, абзацный "
                    + "отступ, выравнивание, текст и выравнивание колонтитулов задаёт пользователь.",
            ""
    ),
    UPLOADED(
            "uploaded",
            "Бланк моей организации",
            "Загрузите фирменный бланк (.docx) — документ будет оформлен на его основе: "
                    + "сохраняются колонтитулы, поля страницы и стили бланка.",
            ""
    );
